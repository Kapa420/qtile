...
keys = [Key(key[0], key[1], *key[2:]) for key in [
    ...
    (["mod1"], "space", lazy.next_layout()),
    ([mod], "Tab", lazy.screen.prev_group()),    
    ...
    # Atom
    ([mod], "t", lazy.spawn("atom")),
    
    # Pavucontrol
    ([mod], "u", lazy.spawn('pavucontrol')),
    
    # Arandr
    ([mod], "a", lazy.spawn('arandr')),
